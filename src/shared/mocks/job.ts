export const jobMock = {
  ...
  employer_website: 'https://www.linkedin.com',
  employer_company_type: 'Information',
  job_publisher: 'LinkedIn',
  job_id: '8yv3oA_2-UYAAAAAAAAAAA==',
  job_employment_type: 'CONTRACTOR',
  job_title:
    'Web Developer - 6-month Contract - Houston Hybrid Web Developer - 6-month Contract - Houston Hybrid Web Developer - 6-month Contract - Houston Hybrid Web Developer - 6-month Contract - Houston Hybrid',
  job_apply_link:
